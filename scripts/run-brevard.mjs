...
// scanned Brevard filing returned nothing the moment USE_AI was 0 (2026-07-14 -> 2026-08-11).
async function addr(file) {
  const r = await extractAddress(file, { county: 'Brevard', useAI: USE_AI, anthropic });
